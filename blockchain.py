...
class Blockchain(object):
  ...
  def __init__(self):
    ...
    genesis_hash= self.hash_block("block pertama")
...
sender_identifier= str(uuid4()).replace("-","")
...
def add_nodes():
  ...
  response={
    'message':'Node baru di tambahkan',
...
def sync():
  ...
  if update:
    response={
    'message':'Blockchian Updated',
    'blockchain':blockchain.chain
    }
  else:
    response={
    'message':'Blockcahin already updated',
    'blockchain':blockchain.chain
    }
